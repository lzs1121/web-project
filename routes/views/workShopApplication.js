...
const meetups = keystone.list('Workshop');
...
exports = module.exports = function (req, res) {
	...
	locals.section = 'workShopApplication';
	...
	view.query('curWorkShops',
		meetups.model.findOne()
		//.where('state', 'past')
			.where('key', req.query.course)
	);

	view.render('workShopApplication');
};
